...
$cant_cho = $bd->calculos("select count(id_cho) from chofer");
?>
<head>
<style>
#contenedor{
...
<div id="superiorMantChofer">	
	...
	<div id="centralMantMantChofer">
		...
		<div id="ListadoCentralChofer">
			<?php
				$bd->listarChofer();
			?>		
            <label>Choferes Registrados</label><input type="text" value="<?php echo $cant_cho?>" class="totales"	readonly="readonly"	name="cant_cho" />	
		</div>
      	<div id="">
